...
export function GradientCard({
  ...
  return (
    <View style={layout.cardWithShadow}>
      <View
        style={[
          layout.card,
          {
...
export function Button({
  ...
  containerStyle,
  ...props
}: BackgroundProps & TextProps & ThemeProps & TouchableOpacity["props"]) {
  const backgroundColor = useThemeColor(background || {}, "buttonBackground");
  const textColor = useThemeColor(textOverride || {}, "buttonText");
...
export function ButtonSmall({
  ...
  containerStyle,
  ...props
}: TextProps & TouchableOpacity["props"]) {
...
export const BlurredBackground = (props?: { bottom?: number }) => (
  <BlurView
    blurType="dark"
    blurAmount={10}
    style={{
